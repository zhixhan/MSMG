...
_C.SOLVER.LW_BOX_REID_1ST = 1.0
_C.SOLVER.LW_BOX_REID_2ND = 1.0
_C.SOLVER.LW_BOX_REID_3RD = 1.0
_C.SOLVER.LW_BOX_SOFTMAX_1ST = 1.0
_C.SOLVER.LW_BOX_SOFTMAX_2ND = 1.0
_C.SOLVER.LW_BOX_SOFTMAX_3RD = 1.0
...
_C.MODEL.ROI_HEAD.TRANSFORMERHEAD_DIM = 384
_C.MODEL.ROI_HEAD.TRANSFORMERHEAD_DECODER_DIM = 384
_C.MODEL.ROI_HEAD.TRANSFORMERHEAD_DEPTH = 1
_C.MODEL.ROI_HEAD.TRANSFORMERHEAD_INCHANNELS = [512, 1024]
_C.MODEL.ROI_HEAD.TRANSFORMERHEAD_SPACIAL_SIZE = [28, 14]
_C.MODEL.ROI_HEAD.TRANSFORMERHEAD_FEATNAME = ["feat_res3","feat_res4"]
_C.MODEL.ROI_HEAD.NAE_FEATNAME = ["part_trans_0", "part_trans_1", "part_trans_2", "part_trans_3", "part_trans_4", "part_trans_5", "part_trans_6", "trans_feat_res4"]
_C.MODEL.ROI_HEAD.TRANSFORMERHEAD_OUTPUT_DIM = [2048, 2048, 2048, 2048, 2048, 2048, 2048, 2048]
_C.MODEL.ROI_HEAD.NAE_INDV_DIM = [19, 19, 18, 18, 18, 18, 18, 128]

# -------------------------------------------------------- #
#                           Loss                           #
# -------------------------------------------------------- #
_C.MODEL.LOSS = CN()
_C.MODEL.LOSS.HARD_MINING = False 
