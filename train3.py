...
from engine3 import evaluate_performance, train_one_epoch
from models.seqnet3 import SeqNet
...
def main(args):
    ...
    softmax_criterion = None
    if cfg.MODEL.LOSS.USE_SOFTMAX:
        softmax_criterion_s1 = SoftmaxLoss(cfg)
        ...
        softmax_criterion_s1.to(device)
    ...
    if cfg.MODEL.LOSS.USE_SOFTMAX:
        params_softmax_s1 = [p for p in softmax_criterion_s1.parameters() if p.requires_grad]
        ...
        params.extend(params_softmax_s1)
    ...
    for epoch in range(start_epoch, cfg.SOLVER.MAX_EPOCHS):
        train_one_epoch(cfg, model, optimizer, train_loader, device, epoch, tfboard, softmax_criterion_s1=softmax_criterion_s1, softmax_criterion_s2=softmax_criterion_s2, softmax_criterion_s3=softmax_criterion_s3)
        lr_scheduler.step()
