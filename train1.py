...
from engine1 import evaluate_performance, train_one_epoch
from models.seqnet1 import SeqNet
...
def main(args):
    ...
    if cfg.MODEL.LOSS.USE_SOFTMAX:
        softmax_criterion = SoftmaxLoss(cfg)
    ...
    if cfg.MODEL.LOSS.USE_SOFTMAX:
        params_softmax = [p for p in softmax_criterion.parameters() if p.requires_grad]
        params.extend(params_softmax)
