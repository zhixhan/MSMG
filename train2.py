...
from engine2 import evaluate_performance, train_one_epoch
from models.seqnet2 import SeqNet
...
def main(args):
    ...
    for epoch in range(start_epoch, cfg.SOLVER.MAX_EPOCHS):
        train_one_epoch(cfg, model, optimizer, train_loader, device, epoch, tfboard, softmax_criterion_s2=softmax_criterion_s2, softmax_criterion_s3=softmax_criterion_s3)
        lr_scheduler.step()
