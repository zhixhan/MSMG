...
def train_one_epoch(cfg, model, optimizer, data_loader, device, epoch, tfboard=None, softmax_criterion_s2=None, softmax_criterion_s3=None):
    model.train()
    ...
    for i, (images, targets) in enumerate(
        ...
        loss_dict, feats_reid_2nd, feats_reid_3rd, targets_reid = model(images, targets, epoch=epoch)
        if cfg.MODEL.LOSS.USE_SOFTMAX:
            softmax_loss_2nd = cfg.SOLVER.LW_BOX_REID_2ND * softmax_criterion_s2(feats_reid_2nd, targets_reid)
            softmax_loss_3rd = cfg.SOLVER.LW_BOX_REID_3RD * softmax_criterion_s3(feats_reid_3rd, targets_reid)
